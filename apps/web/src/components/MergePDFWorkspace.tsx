          ...
          <div className="flex items-center gap-3 pt-1">
            {!mergedBlob ? (
              <button
                ...
                className="rounded-lg bg-accent hover:bg-accent-hover text-white dark:text-black px-5 py-2.5 text-sm font-medium active:scale-[0.98] transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-sm"
              >
                {processing ? (
