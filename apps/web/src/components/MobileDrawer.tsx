              ...
              <div className="flex-1 overflow-y-auto overflow-x-hidden py-5 px-4 space-y-6">
                ...
                <div className="pt-2">
                  <Link
                    href="/extensions"
                    onClick={() => setIsOpen(false)}
                    className="flex items-center justify-center gap-2 px-4 py-3.5 rounded-xl bg-accent text-white dark:text-black shadow-md hover:bg-accent/90 active:scale-95 transition-all w-full"
                  >
