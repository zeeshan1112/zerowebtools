              ...
              >
                <div className="w-full">
                  <div className="flex items-center justify-between mb-3 border-b border-border pb-2">
                    ...
                    <span className="text-[9px] px-2 py-0.5 rounded bg-accent text-white dark:text-black font-semibold font-mono tracking-wider">BEST VALUE</span>
                  </div>
          ...
          <div className="flex flex-wrap items-center gap-3">
            {compressedBlob === null ? (
              <button
                onClick={compress}
                disabled={processing}
                className="rounded-lg bg-accent text-white dark:text-black px-5 py-2.5 text-sm font-medium hover:bg-accent-hover active:scale-[0.98] transition-all disabled:opacity-50 w-full md:w-auto font-mono uppercase tracking-wider"
              >
                {processing ? (
                  progress ? (
