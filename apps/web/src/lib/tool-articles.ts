...
export const TOOL_ARTICLES: Record<
  string,
...
export function generateFallbackArticle(tool: Tool, dict: TranslationDictionary) {
  return {
    title: `${tool.title} ${dict.searchClientSide || "Online"}`,
    sections: [
      {
        heading: `What is the ${tool.title}?`,
        paragraphs: [
